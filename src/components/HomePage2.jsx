        ...
        <div>
            ...
            <div className="w-full space-y-4 md:space-y-0 md:space-x-2 lg:space-x-4 p-4 overflow-hidden">
                <div className="w-full h-auto">
                    <div className="w-full relative">
                        <div className="absolute w-full h-full bg-slate-400 -z-10">
                            <div className="absolute w-1/2 h-2/3 -top-4 -left-10 bg-white rounded-full"></div>
                            <div className="absolute w-3/4 h-1/2 bottom-0 left-[30%] bg-white rounded-full"></div>
                        </div>
                        <div className="w-full h-36">
                            <img className="max-w-max h-full" src="/assets/grow.png" alt="" />
                        </div>
                        <div className="w-full h-28 flex justify-center">
                            <img className="max-w-max h-full" src="/assets/with.png" alt="" />
                        </div>
                    </div>
                    <div className="w-full  p-3 border-t-2 border-t-black border-b-2 border-b-black">
                        <h1 className="font-bold text-5xl font-[Cardo-Bold]">KAPOL GLOBAL ACADEMY (IGCSE)</h1>
                    </div>
                </div>
                ...
                <div className="relative w-full h-full flex flex-col lg:flex-row items-center space-x-2">
                    ...
                    <div className="w-full h-1/2 lg:h-full lg:w-2/3 gap-2 bg-slate-500 p-2">
                        <div className="w-full h-full">
                            <div className="w-full grid grid-cols-2 grid-rows-2 space-y-2 overflow-hidden h-1/2">
                                <div className="space-x-2 col-span-2 row-span-1 flex h-">
                                    <img className="w-1/2 h-auto" src="/assets/classroom-1.jpg" />
                                    <img className="w-1/2" src="/assets/classroom-2.jpg" />
                                </div>
                                <div className="space-x-2 col-span-2 row-span-1 flex h-64">
                                    <img className="w-1/2" src="/assets/mini-library.jpg" />
                                    <img className="w-1/2" src="/assets/slide.jpg" />
                                </div>
                            </div>
                        </div>
                    </div>
