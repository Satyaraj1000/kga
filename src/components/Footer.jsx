            ...
            <ul className="-m-5 flex flex-wrap items-center">
              <li className="p-5">
                ...
                to="/mailto"
                  ...
                  onClick={(e) => {
                    e.preventDefault();
                    handleClick('mailto:example@email.com');
                  }}
                >
                  Privacy Policy
                </NavLink>
          ...
          <div className="w-auto p-8 ">
            <div className="-m-1.5 flex flex-wrap">
              <div className="w-auto p-1.5">
                <a href="#">
                  <div className="flex h-10 w-10 items-center justify-center rounded-full border border-gray-400 transform transition-all delay-100 hover:bg-blue">
                    <svg
                      width="10"
                      height="16"
                      viewBox="0 0 8 14"
